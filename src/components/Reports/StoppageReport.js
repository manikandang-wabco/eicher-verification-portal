...
class StoppageReport extends Component {
  constructor(props) {
    super(props);
    this.handleEvent = this.handleEvent.bind(this);
    this.handleChange = this.handleChange.bind(this);
    this.fetchData = this.fetchData.bind(this);
    document.title = "Stoppage Report";
  ...
  fetchData() {
    ...
    if (this.state.selectedVehicle) {
      ...
      let thersholdValue = this.state.threshold;
      if (this.state.searchByDate == "show") {
        ...
        api =
          "/api/v1/stoppageReport?reportFlag=date&reportThreshold=" +
          thersholdValue +
          "&fromDate=" +
          start +
          "&toDate=" +
        ...
        api =
          "/api/v1/stoppageReport?reportFlag=odo&reportThreshold=" +
          thersholdValue +
          " &startOdo=" +
          start +
          "&endOdo=" +
